  ...
  Future<void> getUserRole() async {
    ...
    if (roleDoc.exists) {
      ...
      await ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("Checking your role "),
      ...
      if (!isProvider) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("You are not a provider")));
        return;
      } else {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text("You are a $job")));
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) =>
                ProviderDashboardPage(job: job, providerName: userName),
          ),
        );
      }
    }
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => WorkApplicationPage(),
                      ),
                    );
                  },
                ),
